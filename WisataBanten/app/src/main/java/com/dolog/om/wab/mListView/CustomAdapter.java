...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView==null)
        {
            convertView=inflater.inflate(R.layout.recycle_items,parent,false);
        }

        TextView nameTxt= (TextView) convertView.findViewById(R.id.nameTxt);
        TextView rinciTxt= (TextView) convertView.findViewById(R.id.rinciTxt);
        ...
        final String rinci=spaceCrafts.get(position).getRinciTxt();
        final int image=spaceCrafts.get(position).getImage();

        nameTxt.setText(name);
        rinciTxt.setText(rinci);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openDetailActivity(name,isiText,rinci,image);
            }
        });
    ...
    private void openDetailActivity(String name,String rinci,String isiText,int image)
    {
        Intent i=new Intent(c, DetailActivity.class);

        i.putExtra("NAME_KEY",name);
        i.putExtra("TEXT_KEY",isiText);
        i.putExtra("RINCI_KEY",rinci);
