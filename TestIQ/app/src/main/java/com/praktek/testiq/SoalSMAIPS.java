...
public class SoalSMAIPS extends Activity {
    private DatabaseQuizIPS dbIPS;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dbIPS = new DatabaseQuizIPS(this);
    ...
    private void setUpWaktu() {
        mCountDownTimer = new CountDownTimer(detik, 1000)
        {
            ...
            public void onFinish()
            {
                ...
                Toast.makeText(SoalSMAIPS.this, "Waktu Habis",
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            double MA = 2 * (jmlBenar/5);
            //double MA = MA1;
            jumlahJawabanYgBenar=jmlBenar;
            double IQ = (MA/CA)*100;
            /*int jumlahJawabanYgBenar = 0;
            int jmlBenar1 = 0;
            int jmlBenar2 = 0;
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalSMAIPS.this).create();
            ...
            tampilKotakAlert.setMessage("Benar " +jumlahJawabanYgBenar + " dari "
                   /* + (listSoal.size() +" soal" + " MA = "+MA + " CA = "+CA + " IQ = "+IQ + " Klasifikasi = "+Keterangan ) );*/
                            + (listSoal.size() +" soal" + " IQ = "+IQ + " Klasifikasi = "+Keterangan ) );
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            SoalSMAIPS.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
