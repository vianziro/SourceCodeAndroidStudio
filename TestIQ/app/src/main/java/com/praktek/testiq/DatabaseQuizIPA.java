...
public class DatabaseQuizIPA extends SQLiteOpenHelper {
    final static String DB_NAME = "db_quizappIPA";
 
    public DatabaseQuizIPA(Context context) {
        super(context, DB_NAME, null, 1);
        // TODO Auto-generated constructor stub
    }
 
    @Override
    public void onCreate(SQLiteDatabase dbIPA) {
        ...
        values.put("soal", "Rangka tersusun dari?");
        values.put("pil_a", "tulang dan daging");
        values.put("pil_b","tulang dan otot");
        values.put("pil_c", "tulang dan kulit");
        values.put("pil_d", "rangkaian tulang");
        values.put("jwban",4);
        dbIPA.insert("tbl_soalQuiz", "soal", values);
 
        values.put("soal", "Alat indra yang paling peka untuk membedakan benda panas dan benda dingin adalah");
        values.put("pil_a", "otot");
        values.put("pil_b", "sendi");
        values.put("pil_c", "daging");
        values.put("pil_d", "rangka");
        values.put("jwban",2);
        dbIPA.insert("tbl_soalQuiz", "soal", values);
        
        values.put("soal", "Penghubung antar tulang disebut?");
        values.put("pil_a", "otot");
        values.put("pil_b", "sendi");
        values.put("pil_c", "daging");
        values.put("pil_d", "rangka");
        ...
        values.put("soal", "Rangsangan yang dapat diterima hidung berupa?");
        values.put("pil_a", "getaran");
        values.put("pil_b", "larutan");
        values.put("pil_c", "bau");
        values.put("pil_d", "cahaya");
        values.put("jwban",3);
        dbIPA.insert("tbl_soalQuiz", "soal", values);
         
        values.put("soal", "Alat indra bagi tubuh berguna untuk?");
        values.put("pil_a", "mengenal keadaan luar tubuh");
        values.put("pil_b", "melindungi organ tubuh");
        values.put("pil_c", "menguatkan tubuh");
        values.put("pil_d", "mengetahui posisi tubuh");
        values.put("jwban",1);
        dbIPA.insert("tbl_soalQuiz", "soal", values);
